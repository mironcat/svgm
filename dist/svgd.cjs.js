...
var SVG$1 = _interopDefault(require('svg.js'));
...
function prepareSVG (rawSvg, filename) {
  if (typeof document === "undefined"){ console.log("HTML DOM not found"); return }  var SVG = svgdom(rawSvg); //mode of svg dom: node or html
  //groups with scalebars
  var groups = getGroups(SVG);

  //extract and measure elements
  var gi = getGroupItems(groups, SVG); //array
...
//# sourceMappingURL=svgd.cjs.js.map
