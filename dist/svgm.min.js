!function(t,e){"object"==typeof exports&&"object"==typeof module?module.exports=e():"function"==typeof define&&define.amd?define([],e):"object"==typeof exports?exports.svgm=e():t.svgm=e()}(window,function(){return function(t){var e={};function n(i){if(e[i])return e[i].exports;var r=e[i]={i:i,l:!1,exports:{}};return t[i].call(r.exports,r,r.exports,n),r.l=!0,r.exports}return n.m=t,n.c=e,n.d=function(t,e,i){n.o(t,e)||Object.defineProperty(t,e,{enumerable:!0,get:i})},n.r=function(t){"undefined"!=typeof Symbol&&Symbol.toStringTag&&Object.defineProperty(t,Symbol.toStringTag,{value:"Module"}),Object.defineProperty(t,"__esModule",{value:!0})},n.t=function(t,e){if(1&e&&(t=n(t)),8&e)return t;if(4&e&&"object"==typeof t&&t&&t.__esModule)return t;var i=Object.create(null);if(n.r(i),Object.defineProperty(i,"default",{enumerable:!0,value:t}),2&e&&"string"!=typeof t)for(var r in t)n.d(i,r,function(e){return t[e]}.bind(null,r));return i},n.n=function(t){var e=t&&t.__esModule?function(){return t.default}:function(){return t};return n.d(e,"a",e),e},n.o=function(t,e){return Object.prototype.hasOwnProperty.call(t,e)},n.p="",n(n.s=0)}([function(t,e,n){"use strict";n(1);var i="strat";function r(){var t=r(SVG.select("path").members),e=r(SVG.select("rect").members);e&&(t=t.concat(e));var n=r(SVG.select("line").members);n&&(t=t.concat(n));var i=[];return t&&t.forEach(function(t){var e=t.item.parent();i.push({group:e,scalefactor:t.scalefactor})}),i;function r(t){var e=[];return t.forEach(function(t){var n=function(t){var e={path:function(t,e){var n=t.node.getAttribute("d"),i=n.indexOf("z"),r=t.length();return i>0&&(alert("Масштабный отрезок в виде закрытой кривой! Это может привести к ошибочным вычислениям. Исправьте отрезок или используйте прямоугольник (rectangles) для масштабного отрезка"),r=t.length()/2),r/e},line:function(t,e){var n=t.array().value,i=n[0],r=n[1],s=function(t,e){var n=t[0],i=e[0],r=t[1],s=e[1];return Math.sqrt((i-=n)*i+(s-=r)*s)}(i,r);return s/e},rect:function(t,e){var n=t.width(),i=t.height();return i>n&&(n=i),n/e}},n=t.type,i=a(t);if("scalebar"===i.label){var r=Number(i.labelvalue),s=e[n](t,r);return s}return!1}(t);n&&e.push({item:t,scalefactor:n})}),e}}function s(t){var e={scalefactor:t.scalefactor,elements:{image:[],text:[],path:[],line:[],rect:[],ellipse:[],circle:[],g:[]}};return t.group.children().forEach(function(n){var r=function(t,e){var n=a(t).label;if("scalebar"===n)return n;var r=t.type,s=t.attr().id,h={type:r,id:s,label:n},u=function(t,e,n){var r=t.type,s=e.split("-"),a={rect:["w","h","area","p","c"],ellipse:["area","w","h","p","c"],circle:["area","w","h","c","diameter"],path:["area","l","h"],line:["l","h"],text:["t","y"],image:["file","folder"],g:["count","d","area"]};if(!a[r])return!1;var h=function(t,e){for(var n=0,i=[],r=0;r<e.length;r++)(n=t.indexOf(e[r]))>=0&&i.push(t[n]);return i}(s,a[r]);0===h.length&&(h={measure:{rect:["w","h"],ellipse:["w","h"],circle:["diameter"],path:["l"],line:["l"],text:["t"],image:["file","folder"],g:["count","d"]},strat:{ellipse:["c"],circle:["c"],line:["h","start"],path:["h","start"],text:["t","y"],g:["count"]}}[i][r]);if(!h)return!1;var u={};return h.forEach(function(e){u[e]=function(t,e,n){var i,r,s=t.attr(),a=0;switch(e){case"ellipse-c":a={x:t.cx()/n,y:t.cy()/n};break;case"ellipse-w":a=t.width()/n;break;case"ellipse-h":a=t.height()/n;break;case"line-l":case"line-h":var h=t.array().value,u=h[0],l=h[1];a=o(u,l)/n;break;case"line-start":var c=t.attr("x1"),f=t.attr("y1"),d=t.attr("y2");d>f&&(f=d),a={x:c,y:f};break;case"circle-c":a={x:t.cx()/n,y:t.cy()/n};break;case"circle-diameter":a=t.height()/n;break;case"rect-start":a={x:t.x()/n,y:t.y()/n};break;case"rect-c":a={x:t.cx()/n,y:t.cy()/n};break;case"rect-area":a=s.width*s.height/(n*n);break;case"rect-l":a=s.height/n;break;case"rect-w":a=t.width()/n;break;case"rect-h":a=t.height()/n;break;case"circle-area":var p=t.height()/2;a=Math.PI*(p*p)/(n*n);break;case"path-start":arrayPoints=t.array().value;var f=arrayPoints[0][2],c=0,m=arrayPoints.length;arrayPoints.forEach(function(t){f<t[2]&&(f=t[2]),c+=t[1]}),a={x:(c/=m)/n,y:f/n};break;case"path-h":a=t.length()/n;break;case"path-area":i=t.node,(r=function(t,e,n){e||(e=1e-4),n||(n=3);for(var i=function t(i,r){for(var s=[i],o=1,h=(r.d-i.d)/n;o<n;o++)s[o]=a(i.d+h*o);if(s.push(r),function(t){for(var e,n,i=0,r=t.length,s=0;s<r;++s)e=t[s],n=t[(s-1+r)%r],i+=(n.x+e.x)*(n.y-e.y);return Math.abs(i/2)}(s)<=e)return[i,r];for(var u=[],o=1;o<s.length;++o){var l=t(s[o-1],s[o]);l.pop(),u=u.concat(l)}return u.push(r),u}(a(0),a(t.getTotalLength())),r=i.length;r--;)i[r]=[i[r].x,i[r].y];var s=t.ownerDocument.createElementNS("http://www.w3.org/2000/svg","polygon");return s.setAttribute("points",i.join(" ")),s;function a(e){var n=t.getPointAtLength(e);return n.d=e,n}}(i,0)).points.numberOfItems,a=function(t){for(var e=0,n=t.points,i=n.numberOfItems,r=0;r<i;++r){var s=n.getItem(r),a=n.getItem((r+i-1)%i);e+=(a.x+s.x)*(a.y-s.y)}return Math.abs(e/2)}(r)/(n*n);break;case"path-l":a=t.length()/n;break;case"text-t":if(t.node.childNodes.length>1){var x=SVG.select("tspan",t.node).members[0].node.textContent,v=SVG.select("desc",t.node).members[0],y=SVG.select("title",t.node).members[0],g="",b="";v&&(g="-"+v.node.textContent),y&&(b="-"+y.node.textContent);var a=x+b+g}else var a=t.text();break;case"text-y":a=t.attr("y")/n;break;case"image-file":var w=s["xlink:href"].split("/");a=w[w.length-1].split(".")[0];break;case"image-folder":var w=s["xlink:href"].split("/");a=w[w.length-2];break;case"g-d":var C=t.select("rect").members[0];if(C)var N=C.attr(),k=N.width*N.height/(n*n);var P=t.children().length-1;a=P/k;break;case"g-count":a=t.children().length-1}return a||"нет измерений"}(t,r+"-"+e,n)}),u}(t,s,e);u&&(h.measures=u);var l=SVG.select("desc",t.node).members[0],c=SVG.select("title",t.node).members[0];l&&(h.desc=l.node.textContent);c&&(h.title=c.node.textContent);return h}(n,t.scalefactor);"scalebar"!=r&&e.elements[r.type]&&e.elements[r.type].push(r)}),e}function a(t){var e=t.attr(),n=e["inkscape:label"];if(!n)return{label:e.id};var i=n.split("=");return{label:i[0],labelvalue:i[1]}}function o(t,e){var n=t[0],i=e[0],r=t[1],s=e[1];return Math.sqrt((i-=n)*i+(s-=r)*s)}t.exports={prepareSVG:function(t){var e=arguments.length>1&&void 0!==arguments[1]?arguments[1]:"";i="measure";var n=document.createElement("DIV");n.setAttribute("id","svgcanvas"),n.setAttribute("hidden","true"),document.body.appendChild(n),SVG("svgcanvas").size("800","900").svg(t);var a=r(),o=[];a.forEach(function(t,e){o.push(s(t))});var h=[];return o.forEach(function(t){var e=function(t){var e=t.elements,n={scalefactor:t.scalefactor},i=[];e.text.forEach(function(t){"name"===t.label&&(n.name=t.measures.t),"comments"!==t.label&&"comment"!==t.label||(n.comments=t.measures.t)}),e.image.forEach(function(t){n.imagefilename=t.measures.file,n.imagefoldername=t.measures.folder}),n.name||(n.name=n.imagefilename);var i=[];return e.path.forEach(function(t){i=i.concat(r(t))}),e.line.forEach(function(t){i=i.concat(r(t))}),e.rect.forEach(function(t){i=i.concat(r(t))}),e.ellipse.forEach(function(t){i=i.concat(r(t))}),e.circle.forEach(function(t){i=i.concat(r(t))}),e.g.forEach(function(t){i=i.concat(r(t))}),i;function r(t){n.scalefactor;var e=[];for(var i in t.measures){var r=t.measures[i];"number"==typeof r&&r>1&&(r=r.toFixed(2));var s={name:n.name,type:t.type+"-"+i,label:t.label,value:r,title:t.title||"",description:t.desc||"",comments:n.comments||""};e.push(s)}return e}}(t);h=h.concat(e)}),h=h.map(function(t,n,i){return t.filename=e,i[n]=t}),document.body.removeChild(n),h}}},function(t,e,n){var i,r;function s(t){return(s="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(t){return typeof t}:function(t){return t&&"function"==typeof Symbol&&t.constructor===Symbol&&t!==Symbol.prototype?"symbol":typeof t})(t)}
/*!
